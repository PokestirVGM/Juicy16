...
The approved Windows toolchain is MSVC, per Phase 4.3 of [ROADMAP.md](../ROADMAP.md). JUCE 8 does not support MinGW as a release toolchain, and this image has not been rebuilt or host-validated.
